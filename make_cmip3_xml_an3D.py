...
PJD 25 Oct 2012     - Copied from /work/durack1/Shared/cmip5 and updated input
PJD 31 Jul 2013     - Updated host info
...
for l in list_an3D_data_paths:
    ...
    startyr     = min(years1)
    endyr       = max(years2)  
    outfilename     = "".join(['cmip3.',model,'.',experiment,'.',realisation,'.an.',realm,'.',variable,'.',version,'.',str(startyr),'-',str(endyr),'.xml'])
